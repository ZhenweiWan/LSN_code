...
parser.add_argument('--save_scores', '--save_score', default=False, action="store_true")
...
parser.add_argument('--cttlstm', default=False, action='store_true', help='add CTTlstm block')
